...
public enum Jt808MessageType {
    ...
    //终端请求时间
    , REQUEST_TIME(0x0F00), REQUEST_TIME_DOWN(0x8F00)

    // 数据上行透传
    , DATA_TRANSMISSION_UP(0x0900), DATA_TRANSMISSION_DOWN(0x8900)
    //OBD行车数据
    ...
    //平台通用应答  下    行
    , SEND_TEXT_INFO_DOWN(0x8300), REPORT_TXT_MSG_UP(0x6006);
